...
class mpdPrimaryGeneratorMessenger;
...
public:
  ...
  /*
  void SetEnergyDisT(G4String);
  void Setdiffspec(G4bool);
  void Setenergyspec(G4bool);
  void Sethisttype(G4String);
  void Setarbint(G4String);
  void Sethistfile(G4String);
  */
...
private:
  G4ParticleGun*  fParticleGun; // G4 particle gunß
    ...
    mpdPrimaryGeneratorMessenger* fGunMessenger;
