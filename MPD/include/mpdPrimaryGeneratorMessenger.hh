...
#ifndef mpdPrimaryGeneratorMessenger_h
#define mpdPrimaryGeneratorMessenger_h 1
...
class mpdPrimaryGeneratorMessenger: public G4UImessenger
{
  public:
    mpdPrimaryGeneratorMessenger(mpdPrimaryGeneratorAction*);
   ~mpdPrimaryGeneratorMessenger();
    
    virtual void SetNewValue(G4UIcommand*, G4String);
    //G4double GetThetaCmd(){return Theta;}
  private:
    mpdPrimaryGeneratorAction* fAction;
   ...
   /*
    ...
    G4UIcmdWithAString* histfileCmd;
    */
